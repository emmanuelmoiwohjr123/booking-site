    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">WanderRest</h3>
            <p className="mb-4">
              Experience comfort and adventure in our thoughtfully designed spaces. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-white transition-colors">Book Now</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Booking Policy</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>123 Adventure Road, Traveler's District, World City</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>hello@wanderrest.com</span>
              </li>
            </ul>
          </div>
        </div>
